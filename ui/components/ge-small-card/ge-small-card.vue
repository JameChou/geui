	...
	<view class="ui-card-small">
		<view class="body">
			<view class="content">
				...
				<view class="score" @tap="tapRate">{{score}}<ge-rates disabled
						:value="score"></ge-rates><text>({{rateNumber}})</text></view>
				<view class="operate"><button @tap="tapButton" class="ui-button"
						:class="buttonType">{{buttonName}}</button></view>
			</view>
