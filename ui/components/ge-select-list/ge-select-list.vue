<template>
	<view class="ui-select-list">
		<view v-for="(item, index) in datas" @tap="chooseItem(item, index)" class="title-section" :class="selectIndex === index ? 'checked' : ''">
...
export default {
	...
	methods: {
		chooseItem(item, index) {
			...
			this.$emit('choose-item', {item: item, index: index});
		}
	}
}
</script>
