<template>
	<ge-page no-tabs>
		<ge-navbar opacity title="日历"></ge-navbar>
				...
				<view class="section-list">
					<view class="section-item">
						...
						<view class="item-body">
							...
							-->
							<view class="operate">
								<switch type="switch" @change="lunarChange" :checked="showLunar"></switch>
							</view>
						</view>
					</view>
					<view class="section-item">
						...
						<view class="item-body">
							...
							<view class="operate">
								<switch type="switch" @change="monthBgChange" :checked="showMonthBg"></switch>
							</view>
						</view>
					</view>
					...
					<view class="section-item">
						...
						<view class="item-body">
							...
							<view class="operate">
								<switch type="switch" @change="changeBtnChange" :checked="showChangeBtn"></switch>
							</view>
						</view>
					</view>
				</view>
		...
		<template v-slot:sheet>
			<ge-sheet big-title="日期" sub-title="日期选择器" ref="modal">
				<view class="margin-top">
					<ge-calendar :show-lunar="showLunar" :show-month-bg="showMonthBg" :show-change-btn="showChangeBtn"
						:weekend="weekend" show-shrink></ge-calendar>
				</view>
			</ge-sheet>
		</template>
	</ge-page>
